...
<body>
                ...
                <div class="col-md-6">
                    ...
                    <div class="action pull-right">
                        ...
                        <ul>
                            ...
                            <li><a href="<%=request.getContextPath()%>/login"><i class="fa fa-user"></i> 로그인</a></li>
	...
	<form name="loginForm" action="<%=request.getContextPath()%>/signup"
		method="post">
		<div class="mb-3">
			<div class="container">

				<div class="row1">
					<label for="exampleInputId" class="form-label">아이디 </label> <input
						type="text" class="form-control" id="exampleInputId" name=id>
				</div>
				<div class="row1">
				...
				<div class="row1">
					<label for="exampleInputTel" class="form-label">전화번호 </label> <input
						type="text" class="form-control" id="exampleInpuTTel" name=tel>
				</div>
				<br>
