		...
		<form action="<%=request.getContextPath() %>/bbsinput" method="post">
			<div class="mb-3">
				<label for="exampleInputEmail1" class="form-label" >작성자</label> <input
					...
					aria-describedby="emailHelp" name="bbs_user" value="${nowuser }" readonly>
			</div>
			<div class="mb-3">
			...
			<div class="form-floating">
				...
				<textarea class="form-control" placeholder="내용을 적어주세요"
					id="floatingTextarea2" style="height: 100px" name="memo"></textarea>
			</div>
			<div class="form-check form-switch">
				<input class="form-check-input" type="checkbox" role="switch"
					id="flexSwitchCheckChecked" name="scheck" value="1"> <label
